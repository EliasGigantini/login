...
const buttonVariants = {
  default:
    "rounded-full px-4 py-2 bg-white text-black transition-color ease-in-out duration-300 hover:bg-blu hover:text-white",
  cancel:
    "rounded-full px-4 py-2 bg-black text-white transition-color ease-in-out duration-300 hover:bg-red hover:text-white",
  delete:
